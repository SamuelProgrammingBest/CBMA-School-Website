    ...
    <FadeIn>
      <div className="p-6">
        <div className="flex flex-col items-center justify-center gap-4">
          <h1 className="text-[30px] font-bold text-accent text-center">
          ...
          {stats.map((stat, i) => (
            ...
            >
              ...
              <div className="mb-6 flex w-full items-center justify-between">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-white/10 text-white backdrop-blur-sm transition-transform duration-300 group-hover:scale-110 p-1">
                  {stat.icon}
                </div>
              </div>
