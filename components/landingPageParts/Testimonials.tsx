...
const Testimonials = () => {
  ...
  {/* FIXED: Removed massive px-10 layout squeezing on mobile */}
  <div className="relative px-2 md:px-12">
    
    {/* FIXED: Changed mobile padding to px-0 so cards stretch edge-to-edge, desktop stays padded */}
    <Carousel className="w-full px-0 md:px-10">
      <CarouselContent>
        {testimonials.map((t, i) => (
          <CarouselItem key={i} className="basis-full md:basis-1/2 lg:basis-1/3">
            <div className="relative h-full rounded-2xl border border-slate-200 bg-white p-5 shadow-sm md:p-9 mx-1">
              ...
              <p className="mt-2 mb-4 text-gray-600 text-sm sm:text-base">{t.text}</p>
